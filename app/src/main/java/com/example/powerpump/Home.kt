...
class Home : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btnGym).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_home2_to_gym)
        }
        view.findViewById<Button>(R.id.btnHomeworkout).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_home2_to_homeWorkout)
        }
